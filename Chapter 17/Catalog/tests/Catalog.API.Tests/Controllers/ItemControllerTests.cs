...
namespace Catalog.API.Tests.Controllers
{
    public class ItemControllerTests : IClassFixture<InMemoryApplicationFactory<Startup>>
    {
        ...
        public ItemControllerTests(InMemoryApplicationFactory<Startup> factory, ITestOutputHelper outputHelper)
        {
            _factory = factory;
        ...
        public async Task get_should_return_paginated_data(string url, int pageSize, int pageIndex)
        {
            ...
            var responseEntity =
                JsonConvert.DeserializeObject<PaginatedItemResponseModel<ItemResponse>>(responseContent);
